...
const Home = () => {
  return (
    <Container>
      ...
      <div
        className={
          "flex flex-col lg:flex-row items-center justify-between px-8 lg:px-16 pb-[10] lg:pb-[8]"
        }
      >
        {/* Text Section */}
      ...
      <div className="bg-[#1F1F1D] w-full ">
        <div>
          <Image
            src="https://firebasestorage.googleapis.com/v0/b/tadorado-tailors.firebasestorage.app/o/The%20besties.jpg?alt=media&token=6e218dd5-f398-410e-ac7e-a4f05ff40b51"
            alt="Traditional Fashion"
            width={350}
            height={650}
            className="object-contain scale-110 lg:scale-120"
