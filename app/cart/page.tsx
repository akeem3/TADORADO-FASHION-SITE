        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex justify-between items-center mt-4">
                      ...
                      <button
                        ...
                        className="text-red-500 hover:text-red-700 flex items-center transition-colors rounded-md"
            ...
            <div className="flex justify-between pt-4">
              <Button
                variant="outline"
                className="text-red-500 hover:text-red-700 hover:bg-red-50 transition-colors rounded-xl"
                onClick={clearCart}
              >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg p-6 sticky top-24">
              ...
              <Button
                className="w-full bg-[#46332E] hover:bg-[#46332E]/90 py-6 text-lg text-white rounded-xl"
