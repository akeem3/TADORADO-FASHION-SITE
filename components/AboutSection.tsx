...
export default function AboutSection() {
  return (
    <div className="w-full bg-[#1F1F1D] relative py-10 lg:py-10 overflow-hidden">
              ...
              <div className="max-w-xl">
                ...
                <div className="space-y-6 text-gray-300">
                  <p className="text-base sm:text-lg leading-relaxed">
                    ...
                    harmonious blend of tradition and modernity, creating
                    timeless pieces that resonate with the contemporary spirit.
                  </p>
                  <p className="text-base sm:text-lg leading-relaxed">
                    Each garment is a testament to our commitment to quality
                    craftsmanship and sustainable practices. We source the
                    finest materials and work with skilled artisans to bring our
                    vision to life, ensuring that every piece tells a unique
                    story.
                  </p>
                </div>
                <div className="mt-8">
